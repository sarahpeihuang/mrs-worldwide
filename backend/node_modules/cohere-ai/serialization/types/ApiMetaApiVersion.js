...
exports.ApiMetaApiVersion = core.serialization.object({
    ...
    billedUnits: core.serialization.property("billed_units", core.serialization.lazyObject(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("..")))).ApiMetaApiVersionBilledUnits; })).optional()),
});
